...
* EXT600        20220615   EDACILLO    Fix with QMSRQH should ignore the records with request status 4
*/
...
public class AddQIReqTest extends ExtendM3Transaction {
  ...
  public void main() {
    ...
    rorn = "";
    qsta = 0;
    ExpressionFactory expQMSRQH = database.getExpressionFactory("QMSRQH");
    expQMSRQH = expQMSRQH.ne("RHQSTA", "4");

    DBAction queryQMSRQH = database.table("QMSRQH")
      .index("20")
      .matching(expQMSRQH)
      .selection("RHQRID", "RHRORN", "RHQSTA")
      .build();
